...
const nombres = ['Gabriel Neira', 'Pablo Ulloa', 'Franco Contreras','Cristobal Valenzuela', 'Juan Carlos Saez', 'Sergio Orellana', 'Jacqueline Flores'];
...
function MarioKart() {
 ...
 /*       if (!oKart.hitos1[0] && oKart.y>=245 && oKart.y<=260 && oKart.x>=10 && oKart.x<=65){
    ...
    function ai(oKart) {
        ...
        if( !(nombres[oKart.id]==='Juan Carlos Saez') && !(nombres[oKart.id]==='Franco Contreras'))
