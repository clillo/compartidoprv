...
const nombres = ['Fabian Badilla', 'Natalia Villagran', 'Gerardo Valenzuela', 'Carolina Montoya', 'Luis Molina', 'Miguel Gonzalez', 'Cristian Angulo' ];
...
function MarioKart() {
 ...
 /*       if (!oKart.hitos1[0] && oKart.y>=245 && oKart.y<=260 && oKart.x>=10 && oKart.x<=65){
    ...
    function ai(oKart) {
        ...
        if( !(nombres[oKart.id]==='Carolina Montoya'))
        	oKart.speed *= Math.max(0.8, 0.3+ Math.random());
...
//        Http.send();
    ...
    for (var i = 0; i < aCharacters.length; i++) {
        var oImg = new Image();
        oImg.src = "media/personajes/sprite_" + aCharacters[i] + ".png";
    }
...
//     	var json = '[{"id":0,"x":476,"y":347,"pos":1,"nombre":"Jugador 1"},{"id":1,"x":460,"y":337,"pos":1,"nombre":"Jugador 2"},{"id":2,"x":476,"y":322,"pos":1,"nombre":"Jugador 3"},{"id":3,"x":460,"y":307,"pos":1,"nombre":"Jugador 4"},{"id":4,"x":476,"y":322,"pos":1,"nombre":"Jugador 5"},{"id":5,"x":460,"y":287,"pos":1,"nombre":"Jugador 6"},{"id":6,"x":476,"y":302,"pos":1,"nombre":"Jugador 7"}]'
//     		
//      console.log('OK');
//     	var theUrl = "/envia?dummy=1";
