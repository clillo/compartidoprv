...
const nombres = ['Jose Narvaez', 'Roberto Alfaro', 'Franco Contreras','Cristobal Valenzuela', 'Cristian Quezada', 'Loretto Herrera', 'Jacqueline Flores'];
...
function MarioKart() {
 ...
 /*       if (!oKart.hitos1[0] && oKart.y>=245 && oKart.y<=260 && oKart.x>=10 && oKart.x<=65){
    ...
    function ai(oKart) {
        ...
        if( !(nombres[oKart.id]==='Jacqueline Flores') && !(nombres[oKart.id]==='Cristobal Valenzuela'))
