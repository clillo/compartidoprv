...
const nombres = ['Jose Narvaez', 'Roberto Alfaro', 'Sergio Orellana','Cristobal Valenzuela', 'Cristian Quezada', 'Loretto Herrera', 'Leonardo Diaz'];
...
function MarioKart() {
 ...
 /*       if (!oKart.hitos1[0] && oKart.y>=245 && oKart.y<=260 && oKart.x>=10 && oKart.x<=65){
    ...
    function ai(oKart) {
        ...
        if( !(nombres[oKart.id]==='Roberto Alfaro') && !(nombres[oKart.id]==='Leonardo Diaz'))
