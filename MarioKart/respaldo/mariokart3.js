...
const nombres = ['Fabian Badilla', 'Miguel Gonzalez', 'Fabian Aravena', 'Gerardo Valenzuela', 'Cristian Angulo', 'Carolina Montoya', 'Luis Molina'];
...
function MarioKart() {
 ...
 /*       if (!oKart.hitos1[0] && oKart.y>=245 && oKart.y<=260 && oKart.x>=10 && oKart.x<=65){
    ...
    function ai(oKart) {
        ...
        if( !(nombres[oKart.id]==='Fabian Aravena') && !(nombres[oKart.id]==='Miguel Gonzalez'))
